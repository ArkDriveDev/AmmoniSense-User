  ...
  useEffect(() => {
    ...
    if (showOdorZones) {
      odorZones.forEach((zone) => {
        ...
        const strokeColor = '#d97706'; // Amber-600 border
        const fillColor = '#fbbf24';   // Amber-400 fill
        ...
        const popupContent = `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 4px; min-width: 180px;">
            ...
            <div style="font-size: 12px; color: #334155; line-height: 1.5;">
              ...
              <b>Readings Inside:</b> ${zone.reading_count !== undefined ? zone.reading_count : 0}<br/>
